------- Definitions --------
- Platform: a compatible set of hardware and software (OS, browser, etc…) that provides an environment for software to run
- Machine Language: Language which CPUs are capable of processing instructions (e.g. 10110000 01100001). The set of all possible machine language instructions that a given CPU can understand is called an instruction set. Not portable between platforms.
- Assembly Language: Language that essentially functions as a more human-readable machine language (e.g. mov al, 0x61). An assembler translates assembly programs into machine language. Not portable between platforms.
- Binary Digit (Bit): Smallest unit of memory (0 or 1)
- Byte: Group of bits that are operated on as a unit (8 bits)
